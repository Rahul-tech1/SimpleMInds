...
public class SimpleMinds extends JFrame implements ActionListener{
	...
	SimpleMinds(){
		...
		JLabel l2 = new JLabel("SIMPLES MINDS");
		l2.setFont(new Font("Viner Hand ITC", Font.BOLD, 30));
		l2.setForeground(new Color(30, 114, 254));
		...
		l3.setForeground(new Color(30, 114, 254));
		l3.setBounds(790, 150, 300, 20);
		add(l3);
